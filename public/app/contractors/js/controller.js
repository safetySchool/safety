...
let controller = {
    ...
    getLastMovementDate(peopleId) {
        return $.ajax({
            type: 'GET',
            url: `/api/people_movement/getLastMovementDate/${globalCredentials.institution[0]}/${peopleId}`,
            dataType: 'json'
        });
    },
    getActivityValidation(peopleId) {
        return $.ajax({
            type: 'GET',
            url: `/api/people_movement/getDocumentValidation/${globalCredentials.institution[0]}/${peopleId}`,
            dataType: 'json'
        });
    },
    ...
    saveData({ phone, name, dni, email, type, empresa, rut_empresa, cargo }) {
        return $.ajax({
            type: 'POST',
            url: '/api/people',
            data: { phone, name, dni, email, type, empresa, rut_empresa, cargo },
            dataType: 'json'
        });
    },
    updateData({ id, phone, name, dni, email, empresa, rut_empresa, cargo }) {
        return $.ajax({
            type: 'PATCH',
            url: '/api/people',
            data: { id, phone, name, dni, email, empresa, rut_empresa, cargo },
            dataType: 'json'
        });
    },
    deletePeople({ id }) {
