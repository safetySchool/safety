controller.btndatatableDocuments = (_id) => {
    ...
    datatableDocument = $('#crud-datatable-document').DataTable({
        ...
        'ajax': {
            'type': 'GET',
            'url': `/api/accident_movement/datatables/${_id}`,
            'dataSrc': '',
            'data': function () {
            }
        },
...
controller.loadTypesDocuments = async () => {
    const options = ['INVESTIGACIÓN ACCIDENTE/ENFERMEDAD',
        'EVIDENCIA IMPLEMENTACIÓN MEDIDA DE CONTROL',
        'DIAT/DIEP',
        'OTROS'];
...
controller.getFilesMovement = async (_id) => {
    return $.ajax({
        type: 'GET',
        url: '/api/accident_movement/getDocuments',
        data: { _id },
        dataType: 'json'
    });
};
...
controller.uploadDocuments = (formData, cb) => {
    $.ajax({
        type: 'POST',
        url: '/api/accident_movement/multipart',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
controller.updateDate = (data) => {
    return $.ajax({
        type: 'PATCH',
        url: '/api/accident_movement/updateDate',
        data: JSON.stringify(data),
        headers: {
            'Content-Type': 'application/json'
        },
