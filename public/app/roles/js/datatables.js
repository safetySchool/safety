...
$(document).ready(function () {
    ...
    datatable = $('#crud-datatable').DataTable({
        ...
        columns: [
            ...
            {
                data: '_id', className: 'permissions', class: 'text-center', render: function (data) {
                    return `<i class="fa fa-eye fa-lg cursor-pointer" onclick="controller.btnDataTable('${data}');"></i>`;
                }
            },
