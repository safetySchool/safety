controller.btndatatableDocuments = (_id) => {
    ...
    datatableDocument = $('#crud-datatable-document').DataTable({
        ...
        'ajax': {
            'type': 'GET',
            'url': `/api/activities_movement/datatables/${_id}`,
            'dataSrc': '',
            'data': function () {
            }
        },
...
controller.getMovementById = async (_id) => {
    return $.ajax({
        type: 'GET',
        url: `/api/activities_movement/${_id}`,
        dataType: 'json'
    });
};
...
controller.getFilesMovement = async (_id) => {
    return $.ajax({
        type: 'GET',
        url: '/api/activities_movement/getDocuments',
        data: {_id},
        dataType: 'json'
    });
};
...
controller.uploadDocuments = (formData, cb) => {
    $.ajax({
        type: 'POST',
        url: '/api/activities_movement/multipart',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
