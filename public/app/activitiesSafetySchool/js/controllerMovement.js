controller.btndatatableDocuments = (_id) => {
    ...
    datatableDocument = $('#crud-datatable-document').DataTable({
        ...
        'ajax': {
            'type': 'GET',
            'url': `/api/activitiesSafetySchool_movement/datatables/${_id}`,
            'dataSrc': '',
            'data': function () {
            }
        },
...
controller.loadTypesDocuments = async () => {
    const typesDocuments = await controller.getTypesDocuments();
    $('#typesDocuments').empty();
    for (const typeDocument of typesDocuments) {
...
controller.saveDocument = (data) => {
    return $.ajax({
        type: 'POST',
        url: '/api/activitiesSafetySchool_movement',
...
controller.getMovementById = async (_id) => {
    return $.ajax({
        type: 'GET',
        url: `/api/activitiesSafetySchool_movement/${_id}`,
        dataType: 'json'
    });
};
...
controller.getFilesMovement = async (_id) => {
    return $.ajax({
        type: 'GET',
        url: '/api/activitiesSafetySchool_movement/getDocuments',
        data: { _id },
        dataType: 'json'
    });
};
...
controller.uploadDocuments = (formData, cb) => {
    $.ajax({
        type: 'POST',
        url: '/api/activitiesSafetySchool_movement/multipart',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
controller.updateDate = (data) => {
    return $.ajax({
        type: 'PATCH',
        url: '/api/activities_movement/updateDate',
        data: JSON.stringify(data),
        headers: {
            'Content-Type': 'application/json'
        },
